...
export default class AudioToolsServer {
    constructor(config, expressSever = null, logHandler = null, clientDepHandler = null, filesystemHandler = null){
        this.config = config;
        ...
        this.expressServer = expressSever||new ExpressServer(this.config, this.logHandler, this.fileSystemHandler);
    }
}
